	...
	$(document).on('click','.photoBiggerBtn',function(){
		...
		$.ajax({
			...
			success : function(photo){
				...
				html += '<img src="http://sh86.kr/resources/files/'+photo.filePath+'/'+photo.fileName+'" style="width:100%;border-radius:20px;"/>';
	   			...
	   			<c:forEach var="photoList" items="${photoList}" varStatus="i">
	   				...
	   				<c:if test="${i.index eq 0}">
	   					...
	   					<td style="width:33%;" class="photoBiggerBtn">
	   						...
	   						<img class="lazy" data-original="http://sh86.kr/resources/files/${photoList.filePath }/${photoList.fileName}" style="width:100%;height:90px;border-radius:10px;"/>
	   					</td>
		    	...
		    	<c:forEach var="photoList" items="${photoList }">
			    	<div style="width:100%;font-size:15px;" id="photoListDiv">
			    		...
			    		<%-- <div class="photoBiggerBtn">
				    		<input type="hidden" id="fileNo" value="${photoList.fileNo }"/> --%>
				    		<img class="lazy" data-original="http://sh86.kr/resources/files/${photoList.filePath }/${photoList.fileName}" style="width:100%;border-radius:10px;"/>
			    		<!-- </div> -->
			    					...
			    					<tr>
			    						<c:choose>
			    							...
			    							<c:when test="${commentList.userImgNew eq null and commentList.userImgOld eq null}">
			    								<td style="border-top:1px solid #ddd;width:50px;">
					    							<img src="http://sh86.kr/resources/img/ready.jpg" style="width:40px;height:40px;border-radius:15px;" />
					    						</td>
			    							</c:when>
			    						</c:choose>
