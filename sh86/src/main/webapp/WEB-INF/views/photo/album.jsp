	...
	$(document).on('click','.photoBiggerBtn',function(){
		...
		$.ajax({
			...
			success : function(photo){
				...
				html += '</td><td style="width:65px;">좋아요 <font style="font-weight:bold;" id="goodCountTagPop">'+photo.photoGoods+'</font></td>';
	    		...
	    		<tr>
	    			<td style="border-bottom:2px solid #ddd;margin-bottom:10px;">
	    				<select id="folderName" data-native-menu="false" style="width:100%;height:36px;" onchange="photoListType(this.value)">
	    					<option value="school01" selected="selected">1반</option>
	    					<option value="school02">2반</option>
	    					<option value="school03">3반</option>
	    					<option value="school04">4반</option>
	    					<option value="school05">5반</option>
	    					<option value="school06">6반</option>
	    					<option value="school07">7반</option>
	    					<option value="school08">8반</option>
	    					<option value="school09">추억</option>
	    					<option value="school10">학교</option>
	    				</select>
	    				<script>
