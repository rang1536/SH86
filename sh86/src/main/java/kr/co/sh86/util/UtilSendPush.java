...
public class UtilSendPush {
	public void androidSendPush(String token, String activityName, String title, String content, int badge){ 
		/*try { 
        ...
        final String apiKey = "AAAAHAOd49U:APA91bEagjL-absMPzNFOaHR1mbZ6nGioKA-8cJNB_Nw16wVtyo17UlFez99CifFo--4pSDMXgGBc52XNhL1V0yZCMLIo4sDYjvKR7MPfJl96tl3HEC64G090uK6A2AUMWGRBXG3BxEV";
        badge++;
        try{
            ...
            /*String input = "{\"notification\" : {\"title\" : \""+ title +"\", \"body\" : \""+content+"\"}, \"to\":\""+token+"\", \"click_action\":\"android.intent.action.MAIN\", \"data\" : {\"badge\":\"2\"} }";*/

            String input = "{\"to\":\""+token+"\", \"click_action\":\"android.intent.action.MAIN\", \"data\" : {\"badge\":\""+badge+"\", \"title\" : \""+ title +"\", \"body\" : \""+content+"\"} }";
